"""Lichess-compatible whole-game accuracy.

Ported from lila modules/analyse/src/main/AccuracyPercent.scala
(gameAccuracy, fromWinPercents) and chess.eval.WinPercent.
