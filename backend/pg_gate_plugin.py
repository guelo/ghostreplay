...
REQUIRED_PG_GATE_TESTS = frozenset({
    ...
    "test_capture_cohort_pg.py::test_schema_v3_captures_distinct_contributing_sessions_by_mode",
    ...
    "test_capture_cohort_pg.py::test_session_mode_mapping_movement_retries_even_when_scorer_freshness_does_not",
